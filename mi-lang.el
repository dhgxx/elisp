...
(when mi-use-xwindow
  ...
  (set-fontset-font "fontset-default" 'ascii '("Monospace" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'latin '("Monospace" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'cyrillic-iso8859-5 '("Monospace" . "unicode-bmp"))
  ...
  (set-fontset-font "fontset-default" 'unicode '("Monospace" . "unicode-bmp"))
  (set-fontset-font "fontset-default" '(#x20ac . #x20ac) '("Monospace" . "unicode-bmp"))
  ;; chinese fill
