...
(when mi-use-xwindow
  ...
  (set-fontset-font "fontset-default" 'chinese-big5-1 '("WenQuanYi Zen Hei Mono" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'chinese-big5-2 '("WenQuanYi Zen Hei Mono" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'chinese-cns11643-1 '("WenQuanYi Zen Hei Mono" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'chinese-cns11643-2 '("WenQuanYi Zen Hei Mono" . "unicode-bmp"))
  (set-fontset-font "fontset-default" 'unicode '("Droid Sans Mono" . "unicode-bmp"))
